class SeminarsController < ApplicationController
  ...
  private
    ...
    def seminar_params
      params.require(:seminar).permit(:title, :thumbnail, :thumbnail_mime_type, :target_id, :holding_method_id, :description, :pdf, :recommend, :appeal, :feedback, :lecturer_profiles, :datetime_of_the_seminar, :program, :course_fee, :preparation, :manual_link)
    end
end
